# This file is use for building gprMax module. It is a modified version of the setup.py file from the gprMax project.
# TODO: This file will be merged into the main setup.py file in the future.
...
if sys.platform == 'win32':
    compile_args = ['/O2', '/openmp',
                    '/w']  # No static linking as no static version of OpenMP library; /w disables warnings
    linker_args = []
    extra_objects = []
    libraries = []
...
#          - with gcc -fopenmp option implies -pthread
    ...
    cpuID = subprocess.check_output("sysctl -n machdep.cpu.brand_string", shell=True, stderr=subprocess.STDOUT).decode(
        'utf-8').strip()
    ...
    compile_args = ['-O3', '-w', '-fopenmp',
                    '-march=native']  # Sometimes worth testing with '-fstrict-aliasing', '-fno-common'
