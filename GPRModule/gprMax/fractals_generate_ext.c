...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "gprMax.fractals_generate_ext",
        "sources": [
            "gprMax/fractals_generate_ext.pyx"
        ]
    },
    "module_name": "gprMax.fractals_generate_ext"
}
END: Cython Metadata */
...
#define __PYX_HAVE__gprMax__fractals_generate_ext
#define __PYX_HAVE_API__gprMax__fractals_generate_ext
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'gprMax.fractals_generate_ext' */
...
static void __pyx_f_6gprMax_21fractals_generate_ext_generate_fractal2D(int, int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_6gprMax_21fractals_generate_ext_generate_fractal3D(int, int, int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "gprMax.fractals_generate_ext"
extern int __pyx_module_is_main_gprMax__fractals_generate_ext;
int __pyx_module_is_main_gprMax__fractals_generate_ext = 0;

/* Implementation of 'gprMax.fractals_generate_ext' */
...
static const char __pyx_k_fractalvolume[] = "fractalvolume";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_fractalsurface[] = "fractalsurface";
...
static PyObject *__pyx_n_s_fractalsurface;
static PyObject *__pyx_n_s_fractalvolume;
...
static PyObject *__pyx_pf_6gprMax_21fractals_generate_ext_generate_fractal2D(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_nx, int __pyx_v_ny, int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalsurface); /* proto */
static PyObject *__pyx_pf_6gprMax_21fractals_generate_ext_2generate_fractal3D(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_nx, int __pyx_v_ny, int __pyx_v_nz, int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalvolume); /* proto */
...
/* "gprMax/fractals_generate_ext.pyx":24
 * 
 * 
...
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_1generate_fractal2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6gprMax_21fractals_generate_ext_generate_fractal2D(CYTHON_UNUSED int __pyx_v_nx, int __pyx_v_ny, CYTHON_UNUSED int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalsurface, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("generate_fractal2D", 0);

  /* "gprMax/fractals_generate_ext.pyx":40
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(__pyx_v_nthreads) private(__pyx_t_10, __pyx_t_11, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_B) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_rr) lastprivate(__pyx_v_v2x) lastprivate(__pyx_v_v2y) schedule(static)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            __pyx_v_rr = ((double)__PYX_NAN());
                            __pyx_v_v2x = ((double)__PYX_NAN());
                            __pyx_v_v2y = ((double)__PYX_NAN());

                            /* "gprMax/fractals_generate_ext.pyx":41
 * 
 *     for i in prange(nx, nogil=True, schedule='static', num_threads=nthreads):
 *         for j in range(ny):             # <<<<<<<<<<<<<<
 *                 # Positional vector for current position
 ...
 */
                            ...
                            for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
                              ...
                              /* "gprMax/fractals_generate_ext.pyx":43
 *         for j in range(ny):
 *                 # Positional vector for current position
 *                 v2x = weighting[0] * i             # <<<<<<<<<<<<<<
 *                 v2y = weighting[1] * j
 ...
 */
                              __pyx_t_7 = 0;
                              __pyx_v_v2x = ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_weighting.data + __pyx_t_7 * __pyx_v_weighting.strides[0]) ))) * __pyx_v_i);

                              /* "gprMax/fractals_generate_ext.pyx":44
 *                 # Positional vector for current position
 *                 v2x = weighting[0] * i
 *                 v2y = weighting[1] * j             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              __pyx_t_7 = 1;
                              __pyx_v_v2y = ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_weighting.data + __pyx_t_7 * __pyx_v_weighting.strides[0]) ))) * __pyx_v_j);

                              /* "gprMax/fractals_generate_ext.pyx":47
 * 
 *                 # Calulate norm of v2 - v1
 ...
 */
                              __pyx_t_7 = 0;
                              __pyx_t_8 = 1;
                              __pyx_v_rr = pow((pow((__pyx_v_v2x - (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_7 * __pyx_v_v1.strides[0]) )))), 2.0) + pow((__pyx_v_v2y - (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_8 * __pyx_v_v1.strides[0]) )))), 2.0)), ((__pyx_t_5numpy_float64_t)(1.0 / 2.0)));

                              /* "gprMax/fractals_generate_ext.pyx":49
 *                 rr = ((v2x - v1[0])**2 + (v2y - v1[1])**2)**(1/2)
 * 
 *                 B = rr**b             # <<<<<<<<<<<<<<
 *                 if B == 0:
 *                     B = 0.9
 */
                              __pyx_v_B = pow(__pyx_v_rr, ((double)__pyx_v_b));

                              /* "gprMax/fractals_generate_ext.pyx":50
 * 
 *                 B = rr**b
 *                 if B == 0:             # <<<<<<<<<<<<<<
 *                     B = 0.9
 ...
 */
                              ...
                              if (__pyx_t_9) {
                                ...
                                /* "gprMax/fractals_generate_ext.pyx":51
 *                 B = rr**b
 *                 if B == 0:
 *                     B = 0.9             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              /* "gprMax/fractals_generate_ext.pyx":53
 *                     B = 0.9
 * 
 *                 fractalsurface[i, j] = A[i, j] / B             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              __pyx_t_8 = __pyx_v_i;
                              __pyx_t_7 = __pyx_v_j;
                              __pyx_t_10 = (*((__pyx_t_double_complex *) ( /* dim=1 */ ((char *) (((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_8 * __pyx_v_A.strides[0]) )) + __pyx_t_7)) )));
                              __pyx_t_11 = __pyx_t_double_complex_from_parts(__pyx_v_B, 0);
                              ...
                              __pyx_t_7 = __pyx_v_i;
                              __pyx_t_8 = __pyx_v_j;
                              *((__pyx_t_double_complex *) ( /* dim=1 */ ((char *) (((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_fractalsurface.data + __pyx_t_7 * __pyx_v_fractalsurface.strides[0]) )) + __pyx_t_8)) )) = __Pyx_c_quot_double(__pyx_t_10, __pyx_t_11);
                            }
                            goto __pyx_L14;
                            __pyx_L8_error:;
                            {
                            ...
                            #endif /* _OPENMP */
                            {
                                ...
                                __pyx_parallel_temp3 = __pyx_v_rr;
                                __pyx_parallel_temp4 = __pyx_v_v2x;
                                __pyx_parallel_temp5 = __pyx_v_v2y;
                            }
                            __pyx_L14:;
                            #ifdef _OPENMP
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              ...
              __pyx_v_rr = __pyx_parallel_temp3;
              __pyx_v_v2x = __pyx_parallel_temp4;
              __pyx_v_v2y = __pyx_parallel_temp5;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("gprMax.fractals_generate_ext.generate_fractal2D", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_1generate_fractal2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6gprMax_21fractals_generate_ext_generate_fractal2D[] = "generate_fractal2D(int nx, int ny, int nthreads, int b, float64_t[:] weighting, float64_t[:] v1, double complex[:, ::1] A, double complex[:, ::1] fractalsurface) -> void\nThis function generates a fractal surface for a 2D array.\n        \n    Args:\n        nx, ny (int): Fractal surface size in cells\n        nthreads (int): Number of threads to use\n        b (int): Constant related to fractal dimension\n        weighting (memoryview): Access to weighting vector\n        v1 (memoryview): Access to positional vector at centre of array, scaled by weighting\n        A (memoryview): Access to array containing random numbers (to be convolved with fractal function)\n        fractalsurface (memoryview): Access to array containing fractal surface data\n    ";
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_1generate_fractal2D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_nx;
  int __pyx_v_ny;
  int __pyx_v_nthreads;
  int __pyx_v_b;
  __Pyx_memviewslice __pyx_v_weighting = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_v1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_A = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_fractalsurface = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_fractal2D (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nx,&__pyx_n_s_ny,&__pyx_n_s_nthreads,&__pyx_n_s_b,&__pyx_n_s_weighting,&__pyx_n_s_v1,&__pyx_n_s_A,&__pyx_n_s_fractalsurface,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ny)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 1); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nthreads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 2); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 3); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weighting)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 4); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 5); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 6); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fractalsurface)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, 7); __PYX_ERR(0, 24, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "generate_fractal2D") < 0)) __PYX_ERR(0, 24, __pyx_L3_error)
      }
    ...
    __pyx_v_nx = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_nx == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_ny = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_ny == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_nthreads = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_nthreads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_b == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_weighting = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_weighting.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_v1 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v1.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_fractalsurface = __Pyx_PyObject_to_MemoryviewSlice_d_dc___pyx_t_double_complex(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_fractalsurface.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("generate_fractal2D", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gprMax.fractals_generate_ext.generate_fractal2D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6gprMax_21fractals_generate_ext_generate_fractal2D(__pyx_self, __pyx_v_nx, __pyx_v_ny, __pyx_v_nthreads, __pyx_v_b, __pyx_v_weighting, __pyx_v_v1, __pyx_v_A, __pyx_v_fractalsurface);
...
static PyObject *__pyx_pf_6gprMax_21fractals_generate_ext_generate_fractal2D(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_nx, int __pyx_v_ny, int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalsurface) {
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6gprMax_21fractals_generate_ext_generate_fractal2D(__pyx_v_nx, __pyx_v_ny, __pyx_v_nthreads, __pyx_v_b, __pyx_v_weighting, __pyx_v_v1, __pyx_v_A, __pyx_v_fractalsurface, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_weighting, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_v1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_A, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_fractalsurface, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "gprMax/fractals_generate_ext.pyx":56
 * 
 * 
...
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_3generate_fractal3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6gprMax_21fractals_generate_ext_generate_fractal3D(CYTHON_UNUSED int __pyx_v_nx, int __pyx_v_ny, int __pyx_v_nz, CYTHON_UNUSED int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalvolume, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("generate_fractal3D", 0);

  /* "gprMax/fractals_generate_ext.pyx":72
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                #endif /* _OPENMP */
                {
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_B) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_k) lastprivate(__pyx_v_rr) lastprivate(__pyx_v_v2x) lastprivate(__pyx_v_v2y) lastprivate(__pyx_v_v2z) schedule(static)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            __pyx_v_v2x = ((double)__PYX_NAN());
                            __pyx_v_v2y = ((double)__PYX_NAN());
                            __pyx_v_v2z = ((double)__PYX_NAN());

                            /* "gprMax/fractals_generate_ext.pyx":73
 * 
 *     for i in prange(nx, nogil=True, schedule='static', num_threads=nthreads):
 *         for j in range(ny):             # <<<<<<<<<<<<<<
 *             for k in range(nz):
 ...
 */
                            ...
                            for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
                              ...
                              /* "gprMax/fractals_generate_ext.pyx":74
 *     for i in prange(nx, nogil=True, schedule='static', num_threads=nthreads):
 *         for j in range(ny):
 *             for k in range(nz):             # <<<<<<<<<<<<<<
 *                 # Positional vector for current position
 ...
 */
                              ...
                              for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
                                ...
                                /* "gprMax/fractals_generate_ext.pyx":76
 *             for k in range(nz):
 *                 # Positional vector for current position
 *                 v2x = weighting[0] * i             # <<<<<<<<<<<<<<
 *                 v2y = weighting[1] * j
 ...
 */
                                __pyx_t_10 = 0;
                                __pyx_v_v2x = ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_weighting.data + __pyx_t_10 * __pyx_v_weighting.strides[0]) ))) * __pyx_v_i);

                                /* "gprMax/fractals_generate_ext.pyx":77
 *                 # Positional vector for current position
 *                 v2x = weighting[0] * i
 *                 v2y = weighting[1] * j             # <<<<<<<<<<<<<<
 *                 v2z = weighting[2] * k
 ...
 */
                                __pyx_t_10 = 1;
                                __pyx_v_v2y = ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_weighting.data + __pyx_t_10 * __pyx_v_weighting.strides[0]) ))) * __pyx_v_j);

                                /* "gprMax/fractals_generate_ext.pyx":78
 *                 v2x = weighting[0] * i
 *                 v2y = weighting[1] * j
 *                 v2z = weighting[2] * k             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                __pyx_t_10 = 2;
                                __pyx_v_v2z = ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_weighting.data + __pyx_t_10 * __pyx_v_weighting.strides[0]) ))) * __pyx_v_k);

                                /* "gprMax/fractals_generate_ext.pyx":81
 * 
 *                 # Calulate norm of v2 - v1
 ...
 */
                                ...
                                __pyx_t_11 = 1;
                                __pyx_t_12 = 2;
                                __pyx_v_rr = pow(((pow((__pyx_v_v2x - (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_10 * __pyx_v_v1.strides[0]) )))), 2.0) + pow((__pyx_v_v2y - (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_11 * __pyx_v_v1.strides[0]) )))), 2.0)) + pow((__pyx_v_v2z - (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_v1.data + __pyx_t_12 * __pyx_v_v1.strides[0]) )))), 2.0)), ((__pyx_t_5numpy_float64_t)(1.0 / 2.0)));

                                /* "gprMax/fractals_generate_ext.pyx":82
 *                 # Calulate norm of v2 - v1
 *                 rr = ((v2x - v1[0])**2 + (v2y - v1[1])**2 + (v2z - v1[2])**2)**(1/2)
 *                 B = rr**b             # <<<<<<<<<<<<<<
 *                 if B == 0:
 ...
 */
                                ...
                                /* "gprMax/fractals_generate_ext.pyx":83
 *                 rr = ((v2x - v1[0])**2 + (v2y - v1[1])**2 + (v2z - v1[2])**2)**(1/2)
 *                 B = rr**b
 *                 if B == 0:             # <<<<<<<<<<<<<<
 *                     B = 0.9
 * 
 */
                                __pyx_t_13 = ((__pyx_v_B == 0.0) != 0);
                                if (__pyx_t_13) {

                                  /* "gprMax/fractals_generate_ext.pyx":84
 *                 B = rr**b
 *                 if B == 0:
 *                     B = 0.9             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                ...
                                /* "gprMax/fractals_generate_ext.pyx":86
 *                     B = 0.9
 * 
 *                 fractalvolume[i, j, k] = A[i, j, k] / B             # <<<<<<<<<<<<<<
 */
                                ...
                                __pyx_t_14 = (*((__pyx_t_double_complex *) ( /* dim=2 */ ((char *) (((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_12 * __pyx_v_A.strides[0]) ) + __pyx_t_11 * __pyx_v_A.strides[1]) )) + __pyx_t_10)) )));
                                __pyx_t_15 = __pyx_t_double_complex_from_parts(__pyx_v_B, 0);
                                ...
                                *((__pyx_t_double_complex *) ( /* dim=2 */ ((char *) (((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fractalvolume.data + __pyx_t_10 * __pyx_v_fractalvolume.strides[0]) ) + __pyx_t_11 * __pyx_v_fractalvolume.strides[1]) )) + __pyx_t_12)) )) = __Pyx_c_quot_double(__pyx_t_14, __pyx_t_15);
                              }
                            }
                            goto __pyx_L16;
                            __pyx_L8_error:;
                            ...
                            #endif /* _OPENMP */
                            {
                                ...
                                __pyx_parallel_temp4 = __pyx_v_rr;
                                __pyx_parallel_temp5 = __pyx_v_v2x;
                                __pyx_parallel_temp6 = __pyx_v_v2y;
                                __pyx_parallel_temp7 = __pyx_v_v2z;
                            }
                            __pyx_L16:;
                            #ifdef _OPENMP
                            #pragma omp flush(__pyx_parallel_why)
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              ...
              __pyx_v_rr = __pyx_parallel_temp4;
              __pyx_v_v2x = __pyx_parallel_temp5;
              __pyx_v_v2y = __pyx_parallel_temp6;
              __pyx_v_v2z = __pyx_parallel_temp7;
              switch (__pyx_parallel_why) {
                    case 4:
                {
                    #ifdef WITH_THREAD
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("gprMax.fractals_generate_ext.generate_fractal3D", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_3generate_fractal3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6gprMax_21fractals_generate_ext_2generate_fractal3D[] = "generate_fractal3D(int nx, int ny, int nz, int nthreads, int b, float64_t[:] weighting, float64_t[:] v1, double complex[:, :, ::1] A, double complex[:, :, ::1] fractalvolume) -> void\nThis function generates a fractal volume for a 3D array.\n\n    Args:\n        nx, ny, nz (int): Fractal volume size in cells\n        nthreads (int): Number of threads to use\n        b (int): Constant related to fractal dimension\n        weighting (memoryview): Access to weighting vector\n        v1 (memoryview): Access to positional vector at centre of array, scaled by weighting\n        A (memoryview): Access to array containing random numbers (to be convolved with fractal function)\n        fractalvolume (memoryview): Access to array containing fractal volume data\n    ";
static PyObject *__pyx_pw_6gprMax_21fractals_generate_ext_3generate_fractal3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_nx;
  int __pyx_v_ny;
  int __pyx_v_nz;
  int __pyx_v_nthreads;
  ...
  __Pyx_memviewslice __pyx_v_v1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_A = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_fractalvolume = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("generate_fractal3D (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nx,&__pyx_n_s_ny,&__pyx_n_s_nz,&__pyx_n_s_nthreads,&__pyx_n_s_b,&__pyx_n_s_weighting,&__pyx_n_s_v1,&__pyx_n_s_A,&__pyx_n_s_fractalvolume,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ny)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 1); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 2); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nthreads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 3); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 4); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weighting)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 5); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 6); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 7); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fractalvolume)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, 8); __PYX_ERR(0, 56, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "generate_fractal3D") < 0)) __PYX_ERR(0, 56, __pyx_L3_error)
      }
    ...
    __pyx_v_nx = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_nx == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_ny = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_ny == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_nz == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_nthreads = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_nthreads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_b == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_weighting = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_weighting.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_v1 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v1.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc___pyx_t_double_complex(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_fractalvolume = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc___pyx_t_double_complex(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_fractalvolume.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("generate_fractal3D", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 56, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gprMax.fractals_generate_ext.generate_fractal3D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6gprMax_21fractals_generate_ext_2generate_fractal3D(__pyx_self, __pyx_v_nx, __pyx_v_ny, __pyx_v_nz, __pyx_v_nthreads, __pyx_v_b, __pyx_v_weighting, __pyx_v_v1, __pyx_v_A, __pyx_v_fractalvolume);
...
static PyObject *__pyx_pf_6gprMax_21fractals_generate_ext_2generate_fractal3D(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_nx, int __pyx_v_ny, int __pyx_v_nz, int __pyx_v_nthreads, int __pyx_v_b, __Pyx_memviewslice __pyx_v_weighting, __Pyx_memviewslice __pyx_v_v1, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_fractalvolume) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("generate_fractal3D", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6gprMax_21fractals_generate_ext_generate_fractal3D(__pyx_v_nx, __pyx_v_ny, __pyx_v_nz, __pyx_v_nthreads, __pyx_v_b, __pyx_v_weighting, __pyx_v_v1, __pyx_v_A, __pyx_v_fractalvolume, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_v1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_A, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_fractalvolume, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "gprMax.fractals_generate_ext.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "gprMax.fractals_generate_ext.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "gprMax.fractals_generate_ext.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gprMax.fractals_generate_ext._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"generate_fractal2D", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6gprMax_21fractals_generate_ext_1generate_fractal2D, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6gprMax_21fractals_generate_ext_generate_fractal2D},
  {"generate_fractal3D", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6gprMax_21fractals_generate_ext_3generate_fractal3D, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6gprMax_21fractals_generate_ext_2generate_fractal3D},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_fractals_generate_ext(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fractals_generate_ext},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fractalsurface, __pyx_k_fractalsurface, sizeof(__pyx_k_fractalsurface), 0, 0, 1, 1},
  {&__pyx_n_s_fractalvolume, __pyx_k_fractalvolume, sizeof(__pyx_k_fractalvolume), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfractals_generate_ext(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfractals_generate_ext(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fractals_generate_ext(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fractals_generate_ext(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fractals_generate_ext(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fractals_generate_ext' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fractals_generate_ext(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fractals_generate_ext", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gprMax__fractals_generate_ext) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gprMax.fractals_generate_ext")) {
      if (unlikely(PyDict_SetItemString(modules, "gprMax.fractals_generate_ext", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "gprMax/fractals_generate_ext.pyx":19
 ...
 */
  ...
  /* "gprMax/fractals_generate_ext.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gprMax.fractals_generate_ext", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gprMax.fractals_generate_ext");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
